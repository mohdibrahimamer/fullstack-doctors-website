...
const Home = () => {
  return (
    <>
      <div className="text-3xl">home page for doctors</div>

      <section
        class="pb-32;
 md:pb-44 bg-[url('https://raw.githubusercontent.com/prebuiltui/prebuiltui/main/assets/hero/bg-with-grid.png')] bg-cover bg-center bg-no-repeat text-slate-800 text-sm"
      >
        <div class="flex flex-col-reverse gap-10 md:flex-row px-4 md:px-16 lg:px-24 xl:px-32 mt-12 md:mt-32">
          <div class="max-md:text-center">
            <h5 class="text-4xl md:text-6xl/[76px] font-semibold max-w-xl bg-gradient-to-r from-slate-900 to-[#51618a] text-transparent bg-clip-text">
              Build Skills That Get You Hired
            </h5>

            <p class="text-sm md:text-base max-w-lg mt-6 max-md:px-2 text-slate-600">
              Join a world-class, personalized learning journey built to turn
              you into a high-performing tech professional — and get hired by
